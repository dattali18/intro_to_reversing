...
int sub_401330();
int riddle_3();
int __cdecl check_riddle3_solution(unsigned __int16 *a1);
int sub_401570();
int sub_401650();
...
int __fastcall sub_401CA0(int a1);
...
__int16 word_404000[8] = { 7, 33, 1, -600, -5000, 1777, 13, 69 }; // weak
char *Str = "###################O####...########.##...#.########.##.###.########....###...X##################"; // idb
...
int riddle_3()
{
  unsigned __int16 v1[8]; // [esp+0h] [ebp-18h] BYREF
...
int __cdecl check_riddle3_solution(unsigned __int16 *a1)
{
  ...
  for ( i = 1; i < 8; ++i )
  {
    if ( word_404000[a1[i]] <= v3 )
      return 0;
    v3 = word_404000[a1[i]];
  }
  return 1;
}
// 404000: using guessed type __int16 word_404000[8];
